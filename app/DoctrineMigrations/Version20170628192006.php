 ...
 */
class Version20170628192006 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE new_table CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE new_table CHANGE id id INT NOT NULL');
